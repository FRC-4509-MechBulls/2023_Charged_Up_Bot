...
public Command redRight_scoreLeaveIntakeScore(boolean reverseForBlue){
    ...
    Command setInitialPose = new InstantCommand(()->swerveSubsystem.resetPose(new Pose2d(new Translation2d(-6.21*finalReverseX,-0.43), Rotation2d.fromDegrees(180+finalZeroAngle)))); //leftmost cube placing position
    DirectToPointCommand backAway = new DirectToPointCommand(swerveSubsystem,new Pose2d(-5.70*finalReverseX,-0.7,Rotation2d.fromDegrees(180+finalZeroAngle)),3,standardPosTolerance,2,0.3, Constants.DriveConstants.turnPValue);
    Command setToPlacingCube = new InstantCommand(()->stateController.setAgArmToPlacing()).andThen(new InstantCommand(()->stateController.setItemType(StateControllerSubsystem.ItemType.CUBE))).andThen(new InstantCommand(()->stateController.setPlacingLevel(StateControllerSubsystem.Level.POS2)));
    SleepCommand sleepCommand = new SleepCommand(1);
    DirectToPointCommand navToPlace = new DirectToPointCommand(swerveSubsystem,new Pose2d(-6.21*finalReverseX,-0.43,Rotation2d.fromDegrees(180+finalZeroAngle)),4, Units.inchesToMeters(0.25),2,0.5,Constants.DriveConstants.turnPValue);
    InstantCommand place = new InstantCommand(()->grabber.overrideDesiredEFWait());
    SleepCommand sleepCommand2 = new SleepCommand(1);
    DirectToPointCommand backAway1 = new DirectToPointCommand(swerveSubsystem,new Pose2d(-5.70*finalReverseX,-0.7,Rotation2d.fromDegrees(180+finalZeroAngle)),3,standardPosTolerance,2,0.5,Constants.DriveConstants.turnPValue);
    Command retractArm = new InstantCommand(()->stateController.setAgArmToHolding());
    DirectToPointCommand backAway2 = new DirectToPointCommand(swerveSubsystem,new Pose2d(-3.0*finalReverseX,-0.7,Rotation2d.fromDegrees(180+finalZeroAngle)),3,standardPosTolerance,2,0.5,Constants.DriveConstants.turnPValue);
    DirectToPointCommand alignToPickup = new DirectToPointCommand(swerveSubsystem,new Pose2d(-2.40*finalReverseX,-1.35,Rotation2d.fromDegrees(pickupAngle)),3,standardPosTolerance,2,0.5,Constants.DriveConstants.turnPValue);
    ...
    DirectToPointCommand navToPickup = new DirectToPointCommand(swerveSubsystem,new Pose2d(-1.56*finalReverseX,-0.82,Rotation2d.fromDegrees(pickupAngle)),3,Units.inchesToMeters(1),2,0.5,Constants.DriveConstants.turnPValue);
    Command setToHoldCone = new InstantCommand(()->stateController.setAgArmToHolding());
    DirectToPointCommand alignToPickup_reversed = new DirectToPointCommand(swerveSubsystem,new Pose2d(-2.40*finalReverseX,-1.35,Rotation2d.fromDegrees(180+finalZeroAngle)),3,standardPosTolerance,2,0.5,Constants.DriveConstants.turnPValue);
    DirectToPointCommand backAway2_again = new DirectToPointCommand(swerveSubsystem,new Pose2d(-3.0*finalReverseX,-0.7,Rotation2d.fromDegrees(180+finalZeroAngle)),3,standardPosTolerance,2,0.5,Constants.DriveConstants.turnPValue);
    ...
    DirectToPointCommand navToPlace2 = new DirectToPointCommand(swerveSubsystem,new Pose2d(-6.21*finalReverseX,-0.98,Rotation2d.fromDegrees(180+finalZeroAngle)),4, Units.inchesToMeters(0.25),2,0.5,Constants.DriveConstants.turnPValue);
    InstantCommand place2 = new InstantCommand(()->grabber.overrideDesiredEFWait());
    SleepCommand sleepCommand4 = new SleepCommand(1);
    DirectToPointCommand backAway3 = new DirectToPointCommand(swerveSubsystem,new Pose2d(-5.70*finalReverseX,-0.7,Rotation2d.fromDegrees(180+finalZeroAngle)),3,standardPosTolerance,2,0.5,Constants.DriveConstants.turnPValue);
