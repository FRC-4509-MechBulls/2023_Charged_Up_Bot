...
public final class Constants {
    ...
    public static final class EndEffectorConstants {
        ...
        public static final double INTAKE_CONE_TOP_OUTPUT = -0.5;
        public static final double INTAKE_CONE_BOTTOM_OUTPUT = 0.5;


        public static final double HOLD_CONE_TOP_OUTPUT = -0.2;
        public static final double HOLD_CONE_BOTTOM_OUTPUT = 0.2;

        public static final double PLACE_CUBE_TOP_OUTPUT = 0.6;
